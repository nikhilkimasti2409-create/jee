    ...
    <aside className="w-20 lg:w-64 flex-shrink-0 glass-panel flex flex-col items-center lg:items-stretch py-6 z-20 h-full">
      ...
      <div className="px-4 mb-6 hidden lg:block">
        ...
        <select 
          ...
          className="w-full bg-slate-50 border border-slate-200 text-slate-800 text-sm rounded-lg focus:ring-primary focus:border-primary block p-2 outline-none focus-visible:ring-2 focus-visible:ring-primary"
        >
      ...
      <nav className="flex-1 flex flex-col gap-2 px-3 lg:px-4">
        {[
          ...
          <Link
            ...
            title={item.label}
            className={clsx(
              "flex items-center justify-center lg:justify-start gap-3 p-3 rounded-lg transition-all duration-200 group relative focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-1",
      ...
      <div className="mt-auto px-3 lg:px-4 pb-4">
        ...
        <button 
          ...
          className="w-full mt-2 text-xs text-slate-500 hover:text-rose-500 hidden lg:block focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-rose-500 rounded-md py-1"
        >
          Sign Out
        </button>
      </div>
