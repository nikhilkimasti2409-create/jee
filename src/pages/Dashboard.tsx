      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
        ...
        <div className="glass-card p-6 h-80 flex flex-col">
          <div className="flex items-center justify-between mb-4">
            ...
            <button aria-label="View all activity" title="View all activity" className="text-slate-400 hover:text-slate-600 focus-visible:ring-2 focus-visible:ring-primary focus:outline-none rounded p-1"><Activity className="w-4 h-4" /></button>
          </div>
