          ...
          <div className="glass-card p-6">
            ...
            <div className="space-y-3">
              <button
                ...
                className="w-full text-left flex items-center justify-between p-3 rounded-lg hover:bg-slate-50 cursor-pointer border border-transparent hover:border-slate-100 transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-primary"
              >
                <div className="flex items-center gap-3">
                  <div className={clsx("w-8 h-8 rounded-full flex items-center justify-center shrink-0", emailAlerts ? "bg-sky-100 text-sky-500" : "bg-slate-100 text-slate-400")}>
                ...
                <div className={clsx("w-10 h-5 shrink-0 rounded-full relative transition-colors", emailAlerts ? "bg-primary" : "bg-slate-300")}>
              ...
              >
                <div className="flex items-center gap-3">
                  <div className={clsx("w-8 h-8 rounded-full flex items-center justify-center shrink-0", dailyReports ? "bg-sky-100 text-sky-500" : "bg-slate-100 text-slate-400")}>
                ...
                <div className={clsx("w-10 h-5 shrink-0 rounded-full relative transition-colors", dailyReports ? "bg-primary" : "bg-slate-300")}>
