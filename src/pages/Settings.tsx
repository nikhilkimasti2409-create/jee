          ...
          <div className="glass-card p-6">
            ...
            <div className="space-y-3">
              <button
                ...
                aria-label="Toggle Real-time Security Alerts"
                onClick={toggleEmailAlerts}
                className="w-full flex items-center justify-between p-3 rounded-lg hover:bg-slate-50 cursor-pointer border border-transparent hover:border-slate-100 focus:outline-none focus-visible:ring-2 focus-visible:ring-primary/50 transition-colors text-left"
              >
