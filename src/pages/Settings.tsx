          ...
          <div className="glass-card p-6">
            ...
            <div className="space-y-3">
              <button
                ...
                className="w-full text-left flex items-center justify-between p-3 rounded-lg hover:bg-slate-50 focus:bg-slate-50 focus:outline-none focus-visible:ring-2 focus-visible:ring-primary/50 cursor-pointer border border-transparent hover:border-slate-100 transition-colors"
              >
                <div className="flex items-center gap-3">
                  <div className={clsx("w-8 h-8 rounded-full flex items-center justify-center", emailAlerts ? "bg-sky-100 text-sky-500" : "bg-slate-100 text-slate-400")}>
                    {emailAlerts ? <Bell className="w-4 h-4" aria-hidden="true" /> : <BellOff className="w-4 h-4" aria-hidden="true" />}
                  </div>
                  <div>
                ...
                <div className={clsx("w-10 h-5 rounded-full relative transition-colors shrink-0", emailAlerts ? "bg-primary" : "bg-slate-300")}>
              ...
              >
                <div className="flex items-center gap-3">
                  <div className={clsx("w-8 h-8 rounded-full flex items-center justify-center", dailyReports ? "bg-sky-100 text-sky-500" : "bg-slate-100 text-slate-400")}>
                    {dailyReports ? <Mail className="w-4 h-4" aria-hidden="true" /> : <BellOff className="w-4 h-4" aria-hidden="true" />}
                  </div>
                  <div>
                ...
                <div className={clsx("w-10 h-5 rounded-full relative transition-colors shrink-0", dailyReports ? "bg-primary" : "bg-slate-300")}>
